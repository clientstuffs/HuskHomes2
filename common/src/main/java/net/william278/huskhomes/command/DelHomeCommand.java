...
public class DelHomeCommand extends SavedPositionCommand<Home> {
    ...
    public void execute(@NotNull CommandUser executor, @NotNull String[] args) {
        if (executor instanceof OnlineUser && handleDeleteAll((OnlineUser) executor, args)) {
            return;
        }
    ...
    public void execute(@NotNull CommandUser executor, @NotNull Home home, @NotNull String[] args) {
        if (executor instanceof OnlineUser && !home.getOwner().equals(executor) && !executor.hasPermission(getOtherPermission())) {
