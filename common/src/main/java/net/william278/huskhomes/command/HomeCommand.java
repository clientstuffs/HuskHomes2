...
public abstract class HomeCommand extends SavedPositionCommand<Home> {
    ...
    public void execute(@NotNull CommandUser executor, @NotNull Home home, @NotNull String[] args) {
        ...
        if (executor instanceof OnlineUser && !executor.hasPermission(getOtherPermission())
                && (!home.getOwner().equals(executor) && !home.isPublic())) {
        ...
        this.teleport(executor, optionalTeleporter.get(), home, "home");
    }
